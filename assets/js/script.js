$(document).ready(function(){
    ...
    $('#date-selector input').val(dayjs().format("YYYY-MM-DD"))
    ...
    $('#date-selector input').on('change', function(){
        date = dayjs($(this).val()).format("YYYY-MM-DD")
        $('p.lead').text("You are looking at: "+dayjs(date).format("D MMMM YYYY"))
        createTimeBlocks();
    })
